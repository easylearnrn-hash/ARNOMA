        ...
        <div class="student-view" onclick="toggleInlineEdit('${student.id}', event)">
          ...
          <div class="student-info">
            ...
            <div class="info-row">
              ...
              <span class="info-value" style="color: ${(student.balance || 0) >= 0 ? '#22c55e' : '#ef4444'};">${formatCurrency(student.balance || 0, '$')}</span>
            </div>
  ...
  calendarData.days.forEach(dayData => {
    ...
    html += `
          <div onclick="openDayDetails('${dateStr}', ${JSON.stringify(dayData).replace(/"/g, '&quot;')})"
            ...
            <div style="font-size: 14px; font-weight: 700; color: ${isToday ? '#8ab4ff' : hasSkippedClass ? 'rgba(150,150,150,0.8)' : 'white'}; margin-bottom: 8px; ${hasSkippedClass ? 'text-decoration: line-through;' : ''}">
              ${dayData.day}
              ${isToday ? '<span style="font-size: 9px; color: #8ab4ff; margin-left: 4px;">TODAY</span>' : ''}
              ${hasSkippedClass ? '<span style="font-size: 9px; color: rgba(150,150,150,0.7); margin-left: 4px;">⚫ SKIPPED</span>' : ''}
            </div>
            <div style="flex: 1; display: flex; flex-wrap: wrap; gap: 4px; align-content: flex-start;">
    ...
    studentsHTML += `
          <div style="padding: 14px; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; margin-bottom: 10px; transition: all 0.2s; cursor: pointer;"
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
              <div>
                <div style="font-size: 15px; font-weight: 700; color: white; margin-bottom: 4px;">${escapeHtml(student.name)}</div>
                <div style="font-size: 11px; color: rgba(255,255,255,0.5);">Group ${student.group || 'N/A'} • ${formatCurrency(pricePerClass, '$')}/class</div>
              </div>
              <div style="display: flex; align-items: center; gap: 6px;">
