...
**Test Date:** November 19, 2025 **Tested By:** GitHub Copilot **Version:**
2.2.3 **Files Tested:** index.html, index.mobile.html,
...
- **Status:** ✅ PASS
- **Regex Pattern:** Correct - removes everything after "The money is ready for
  use"
...
- **Result:** These are NOT duplicates - they're separate features with
